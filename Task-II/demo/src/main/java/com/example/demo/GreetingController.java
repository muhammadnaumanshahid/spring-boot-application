...
public class GreetingController {
    ...
    InputStream serviceAccount = this.getClass().getClassLoader().getResourceAsStream("library-app-2793657-firebase-adminsdk-lxg3f-9f50767650.json");
    // FireBase options set
    FirebaseOptions options = new FirebaseOptions.Builder()
            .setCredentials(GoogleCredentials.fromStream(serviceAccount))
            .setDatabaseUrl("https://library-app-2793657.firebaseio.com")
            .build();
    // FireBase init
    ...
    DatabaseReference ref = database.getReference("invitations");
